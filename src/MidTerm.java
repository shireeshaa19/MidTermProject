...
public class MidTerm {
	...
	public static void main(String[] args) {
		...
		System.out.println("James was no match for the bugs and monkeys. They tore into him with ease. James screamed out for Kyle, but Kyle knew James had less than a 60% so saving hims was a mute point. So Kyle picked up David (Who had an 80% and chose to save him instead.");
