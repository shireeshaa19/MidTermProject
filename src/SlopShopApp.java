...
public class SlopShopApp {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println(String.format("%-26s%-12s%-15s%-12s", "    Product", "Category", "Description", "Price"));
		System.out.println("----------------------------------------------------------");
		boolean valid = true;
		do {
		...
		do {
			...
			if (userPayment.equalsIgnoreCase("cash")) {
				System.out.println("Your change is $" + df2.format(SlopMethods.cash(grandTotal, scnr)));
